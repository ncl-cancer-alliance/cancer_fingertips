...
WITH latest AS (
    ...
    FROM DATA_LAKE__NCL.FINGERTIPS.INDICATOR_DATA_V_1_1_0
...
FROM DATA_LAKE__NCL.FINGERTIPS.INDICATOR_DATA_V_1_1_0 fin
...
GROUP BY fin."Indicator ID", fin.AREA_ID, fin.DATE_UPDATED_LOCAL, latest._TIMESTAMP
